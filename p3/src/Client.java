...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean done = strFromUser.equals("quit") == true;
            while (!done) {
                ...
                try {
                    ...
                    if (response != Server.WINNER) {
                        ...
                        strFromUser = getInput(inFromUser);
                    }
                    done = strFromUser.equals("quit") == true || response == Server.WINNER;
                }
